...
namespace Assignment123.View
{
    public partial class ExamForm : Form
    {
        ...
        private void Add_exam_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                int selectedSubjectId = (int)sub_box.SelectedValue;
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                selectedExamId = Convert.ToInt32(row.Cells["Id"].Value);  // Make sure column name is correct
        ...
        private void edit_exam_Click(object sender, EventArgs e)
        {
        ...
        private void delete_exam_Click_1(object sender, EventArgs e)
        {
            if (selectedExamId == -1)
            {
                MessageBox.Show("Please select an exam to delete.");
